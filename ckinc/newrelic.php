...
class cNewRelicEUMAccount {
    ...
    function __construct($psAccountID, $psTrustKey, $psAgentID, $psLicenseKey, $psApplicationID) {
        $this->AccountID = $psAccountID;
        $this->TrustKey = $psTrustKey;
        $this->AgentID = $psAgentID;
        $this->LicenseKey = $psLicenseKey;
        $this->ApplicationID = $psApplicationID;
    }
}
...
class cNewRelic {
    public static function browser_agent() {
        $oCred = (cCommonEnvironment::is_localhost() ? cAppSecret::$NR_PROD : cAppSecret::$NR_DEV);
?>
        <script>
            ;
            window.NREUM || (NREUM = {});
            ...
            NREUM.loader_config = {
                accountID: "<?= $oCred->AccountID ?>",
                trustKey: "<?= $oCred->TrustKey ?>",
                agentID: "<?= $oCred->AgentID ?>",
                licenseKey: "<?= $oCred->LicenseKey ?>",
                applicationID: "<?= $oCred->ApplicationID ?>"
            };
            NREUM.info = {
